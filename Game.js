function Game(options) {
    ...
    function init() {
        ...
        canvasInv.drawInventoryGrid();
        canvasInv.setInventory(dataStruct, activeHero, SPRITES, idGamer, SIZE);             
        if (activeHero.backpack[x + y * 3] && x < 3) {
            if (x <= 2 && y <= 6 && x >= 0 && y >= 0) {
                if (y == 5 && x == 1) {
    ...
    //     canvasInv.drawInventoryGrid();
    //     canvasInv.setInventory(dataStruct, activeHero, SPRITES, idGamer, SIZE);             
    //     if (activeHero.inventory.head!= null && x>3) {
    //         if (xPos > 420 && xPos < 480 && yPos > 60 && yPos < 120) {
    //             canvasInv.fillRightInv();
    //             canvasInv.setInventory(dataStruct, activeHero, SPRITES, idGamer, SIZE);
    //             canvasInv.drawInventoryGrid();
    //             console.log("dddddddddddddddddddd");
    //             canvasInv.printInventoryDescription(xPos, yPos, activeHero);
    //             canvasInv.fillRightInv();
    //         } 
    //     }
    // });
